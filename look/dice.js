...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-de83333c');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-de83333c');}
...
function clearFlash(){dieView.classList.remove('rl-win-de83333c');dieView.classList.remove('rl-lose-de83333c');if(frameEl){frameEl.classList.remove('rl-win-de83333c');frameEl.classList.remove('rl-lose-de83333c');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-de83333c');if(frameEl){frameEl.classList.add('rl-win-de83333c');}}else{dieView.classList.add('rl-lose-de83333c');if(frameEl){frameEl.classList.add('rl-lose-de83333c');}}
...
var brandEl=document.querySelector('.rl-brand-de83333c');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
